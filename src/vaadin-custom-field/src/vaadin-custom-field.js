...
`;
  ...
  static get observers() {
    return ['__getActiveErrorId(invalid, errorMessage, __errorId)', '__getActiveLabelId(label, __labelId)', '__toggleHasValue(value)'];
  }
  ...
  __getActiveErrorId(invalid, errorMessage, errorId) {
    this.__setOrToggleAttribute('aria-describedby', errorMessage && invalid ? errorId : undefined, this);
  }
