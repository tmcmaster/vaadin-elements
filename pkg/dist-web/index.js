...
import { idlePeriod, animationFrame, microTask } from '@polymer/polymer/lib/utils/async.js';
import { Debouncer } from '@polymer/polymer/lib/utils/debounce.js';
import { enqueueDebouncer, flush } from '@polymer/polymer/lib/utils/flush.js';
import { html as html$1 } from '../../../../../../../polymer/lib/utils/html-tag.js';
import '../../../../../../../polymer/polymer-legacy.js';
import { afterNextRender, beforeNextRender } from '../../../../../../../polymer/lib/utils/render-status.js';
import { animationFrame as animationFrame$1, timeOut, microTask as microTask$1 } from '../../../../../../../polymer/lib/utils/async.js';
import { flush as flush$2 } from '../../../../../../../polymer/lib/utils/flush.js';
...
import { Debouncer as Debouncer$1 } from '../../../../../../../polymer/lib/utils/debounce.js';
import { GestureEventListeners as GestureEventListeners$1 } from '../../../../../../../polymer/lib/mixins/gesture-event-listeners.js';
...
import { PolymerElement as PolymerElement$1 } from '../../../../../../../polymer/polymer-element.js';
import { templatize } from '../../../../../../../polymer/lib/utils/templatize.js';
import { addListener as addListener$1 } from '@polymer/polymer/lib/utils/gestures.js';
...
const PolymerIronList = Class({
  ...
  scrollToIndex: function (idx) {
    ...
    flush ? flush() : flush$1(); // Items should have been rendered prior scrolling to an index.
  ...
  */
  ...
  _increasePoolIfNeeded(count) {
    ...
    if (!this._initialPoolCreated) {
      ...
      this._debounceIncreasePool = Debouncer$1.debounce(this._debounceIncreasePool, animationFrame$1, () => {
        this._updateMetrics();
  ...
  _accessIronListAPI(cb) {
    ...
    this._debouncerWarnPrivateAPIAccess = Debouncer$1.debounce(this._debouncerWarnPrivateAPIAccess, animationFrame$1, () => this._warnPrivateAPIAccessAsyncEnabled = true);
    return returnValue;
  }
...
const ColumnResizingMixin = superClass => class ColumnResizingMixin extends GestureEventListeners$1(superClass) {
  ready() {
    super.ready();
...
const DataProviderMixin = superClass => class DataProviderMixin extends superClass {
  ...
  _dataProviderChanged(dataProvider, oldDataProvider) {
    ...
    this._debouncerCheckSize = Debouncer$1.debounce(this._debouncerCheckSize, timeOut.after(2000), this._checkSize.bind(this));
...
const DynamicColumnsMixin = superClass => class DynamicColumnsMixin extends superClass {
  ...
  _addNodeObserver() {
    this._observer = new FlattenedNodesObserver(this, info => {
      ...
      this._debouncerCheckImports = Debouncer$1.debounce(this._debouncerCheckImports, timeOut.after(2000), this._checkImports.bind(this));
  ...
  _checkImports() {
    ['vaadin-grid-column-group', 'vaadin-grid-filter', 'vaadin-grid-filter-column', 'vaadin-grid-tree-toggle', 'vaadin-grid-selection-column', 'vaadin-grid-sort-column', 'vaadin-grid-sorter'].forEach(elementName => {
      ...
      if (element && !(element instanceof PolymerElement$1)) {
...
class GridTemplatizer extends class extends PolymerElement$1 {} {
  static get is() {
...
const ScrollMixin = superClass => class ScrollMixin extends superClass {
  ...
  ready() {
    ...
    this.addEventListener('wheel', e => {
      ...
      this._debouncerWheelScrolling = Debouncer$1.debounce(this._debouncerWheelScrolling, timeOut.after(this._timeouts.WHEEL_SCROLLING), () => this._wheelScrolling = false);
  ...
  _onWheel(e) {
    ...
    this._debouncerWheelAnimationFrame = Debouncer$1.debounce(this._debouncerWheelAnimationFrame, animationFrame$1, () => this._wheelAnimationFrame = false);
    ...
    if (this._canScroll(table, e.deltaX, deltaY)) {
      ...
      this._debouncerIgnoreNewWheel = Debouncer$1.debounce(this._debouncerIgnoreNewWheel, timeOut.after(this._timeouts.IGNORE_WHEEL), () => this._ignoreNewWheel = false);
  ...
  _scheduleScrolling() {
    ...
    this._debounceScrolling = Debouncer$1.debounce(this._debounceScrolling, timeOut.after(this._timeouts.SCROLLING), () => {
    ...
    this._debounceScrollPeriod = Debouncer$1.debounce(this._debounceScrollPeriod, timeOut.after(this._timeouts.SCROLL_PERIOD), () => {
    ...
    if (window.ShadyDOM) {
      microTask$1.run(() => {
        ...
        Array.from(sorters).forEach(sorter => {
          ...
          if (sorter instanceof PolymerElement$1) {
...
const ColumnReorderingMixin = superClass => class ColumnReorderingMixin extends GestureEventListeners(superClass) {
  ...
  ready() {
    super.ready();
    addListener$1(this, 'track', this._onTrackEvent);
...
class GridColumnElement extends ColumnBaseMixin(PolymerElement$1) {
  static get is() {
...
class GridOuterScrollerElement extends class extends PolymerElement$1 {} {
  static get template() {
    return html$1`
    <style>
      :host {
...
`;
  ...
  _updateItem(row, item) {
    ...
    this._debouncerUpdateHeights = Debouncer$1.debounce(this._debouncerUpdateHeights, timeOut.after(1), () => {
      this._updateMetrics();
  ...
  __forceReflow() {
    this._debouncerForceReflow = Debouncer$1.debounce(this._debouncerForceReflow, animationFrame$1, () => {
