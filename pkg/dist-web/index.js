...
import { idlePeriod, animationFrame, microTask, timeOut } from '@polymer/polymer/lib/utils/async.js';
...
const $_documentContainer$a = html`<dom-module id="lumo-text-field" theme-for="vaadin-text-field">
  <template>
...
const $_documentContainer$c = html`<dom-module id="lumo-button" theme-for="vaadin-button">
  <template>
    <style>
      :host {
        /* Sizing */
