...
require('../../../../../../../polymer/lib/elements/custom-style.js');
var domModule_js = require('../../../../../../../polymer/lib/elements/dom-module.js');
...
var htmlTag_js$1 = require('../../../../../../../polymer/lib/utils/html-tag.js');
require('../../../../../../../polymer/polymer-legacy.js');
var renderStatus_js = require('../../../../../../../polymer/lib/utils/render-status.js');
var async_js$1 = require('../../../../../../../polymer/lib/utils/async.js');
var flush_js$1 = require('../../../../../../../polymer/lib/utils/flush.js');
var polymerLegacy_js$1 = require('@polymer/polymer/polymer-legacy.js');
...
var debounce_js$1 = require('../../../../../../../polymer/lib/utils/debounce.js');
var gestureEventListeners_js$1 = require('../../../../../../../polymer/lib/mixins/gesture-event-listeners.js');
var gestures_js = require('../../../../../../../polymer/lib/utils/gestures.js');
var flattenedNodesObserver_js = require('../../../../../../../polymer/lib/utils/flattened-nodes-observer.js');
var polymerElement_js$1 = require('../../../../../../../polymer/polymer-element.js');
var templatize_js = require('../../../../../../../polymer/lib/utils/templatize.js');
var gestures_js$1 = require('@polymer/polymer/lib/utils/gestures.js');
...
const $_documentContainer$7 = htmlTag_js$1.html`<dom-module id="lumo-grid" theme-for="vaadin-grid">
  <template>
    <style>
      :host {
        font-family: var(--lumo-font-family);
  ...
  */
  ...
  _increasePoolIfNeeded(count) {
    ...
    if (!this._initialPoolCreated) {
      ...
      this._debounceIncreasePool = debounce_js$1.Debouncer.debounce(this._debounceIncreasePool, async_js$1.animationFrame, () => {
        this._updateMetrics();
  ...
  _accessIronListAPI(cb) {
    ...
    this._debouncerWarnPrivateAPIAccess = debounce_js$1.Debouncer.debounce(this._debouncerWarnPrivateAPIAccess, async_js$1.animationFrame, () => this._warnPrivateAPIAccessAsyncEnabled = true);
    return returnValue;
  }
...
const ArrayDataProviderMixin = superClass => class ArrayDataProviderMixin extends superClass {
  ...
  _checkPaths(arrayToCheck, action, items) {
    ...
    for (var i in arrayToCheck) {
      ...
      if (polymerLegacy_js$1.Base.get(parentProperty, items[0]) === undefined) {
  ...
  _multiSort(a, b) {
    return this._sorters.map(sort => {
      if (sort.direction === 'asc') {
        return this._compare(polymerLegacy_js$1.Base.get(sort.path, a), polymerLegacy_js$1.Base.get(sort.path, b));
      } else if (sort.direction === 'desc') {
        return this._compare(polymerLegacy_js$1.Base.get(sort.path, b), polymerLegacy_js$1.Base.get(sort.path, a));
      }
  ...
  _filter(items) {
    return items.filter((item, index) => {
      return this._filters.filter(filter => {
        const value = this._normalizeEmptyValue(polymerLegacy_js$1.Base.get(filter.path, item));
...
const ColumnResizingMixin = superClass => class ColumnResizingMixin extends gestureEventListeners_js$1.GestureEventListeners(superClass) {
  ready() {
    super.ready();
...
const DataProviderMixin = superClass => class DataProviderMixin extends superClass {
  ...
  _dataProviderChanged(dataProvider, oldDataProvider) {
    ...
    this._debouncerCheckSize = debounce_js$1.Debouncer.debounce(this._debouncerCheckSize, async_js$1.timeOut.after(2000), this._checkSize.bind(this));
...
const DynamicColumnsMixin = superClass => class DynamicColumnsMixin extends superClass {
  ...
  _addNodeObserver() {
    this._observer = new flattenedNodesObserver_js.FlattenedNodesObserver(this, info => {
      ...
      this._debouncerCheckImports = debounce_js$1.Debouncer.debounce(this._debouncerCheckImports, async_js$1.timeOut.after(2000), this._checkImports.bind(this));
  ...
  _checkImports() {
    ['vaadin-grid-column-group', 'vaadin-grid-filter', 'vaadin-grid-filter-column', 'vaadin-grid-tree-toggle', 'vaadin-grid-selection-column', 'vaadin-grid-sort-column', 'vaadin-grid-sorter'].forEach(elementName => {
      ...
      if (element && !(element instanceof polymerElement_js$1.PolymerElement)) {
...
class GridTemplatizer extends class extends polymerElement_js$1.PolymerElement {} {
  static get is() {
...
const ScrollMixin = superClass => class ScrollMixin extends superClass {
  ...
  ready() {
    ...
    this.addEventListener('wheel', e => {
      ...
      this._debouncerWheelScrolling = debounce_js$1.Debouncer.debounce(this._debouncerWheelScrolling, async_js$1.timeOut.after(this._timeouts.WHEEL_SCROLLING), () => this._wheelScrolling = false);
  ...
  _onWheel(e) {
    ...
    this._debouncerWheelAnimationFrame = debounce_js$1.Debouncer.debounce(this._debouncerWheelAnimationFrame, async_js$1.animationFrame, () => this._wheelAnimationFrame = false);
    ...
    if (this._canScroll(table, e.deltaX, deltaY)) {
      ...
      this._debouncerIgnoreNewWheel = debounce_js$1.Debouncer.debounce(this._debouncerIgnoreNewWheel, async_js$1.timeOut.after(this._timeouts.IGNORE_WHEEL), () => this._ignoreNewWheel = false);
  ...
  _scheduleScrolling() {
    ...
    this._debounceScrolling = debounce_js$1.Debouncer.debounce(this._debounceScrolling, async_js$1.timeOut.after(this._timeouts.SCROLLING), () => {
    ...
    this._debounceScrollPeriod = debounce_js$1.Debouncer.debounce(this._debounceScrollPeriod, async_js$1.timeOut.after(this._timeouts.SCROLL_PERIOD), () => {
  ...
  _updateOverflow() {
    ...
    this._debounceOverflow = debounce_js$1.Debouncer.debounce(this._debounceOverflow, async_js$1.animationFrame, () => {
  ...
  _frozenCellsChanged() {
    this._debouncerCacheElements = debounce_js$1.Debouncer.debounce(this._debouncerCacheElements, async_js$1.microTask, () => {
    ...
    if (window.ShadyDOM) {
      async_js$1.microTask.run(() => {
        ...
        Array.from(sorters).forEach(sorter => {
          ...
          if (sorter instanceof polymerElement_js$1.PolymerElement) {
...
const ColumnReorderingMixin = superClass => class ColumnReorderingMixin extends gestureEventListeners_js.GestureEventListeners(superClass) {
  ...
  ready() {
    super.ready();
    gestures_js$1.addListener(this, 'track', this._onTrackEvent);
...
class GridColumnElement extends ColumnBaseMixin(polymerElement_js$1.PolymerElement) {
  static get is() {
...
class GridOuterScrollerElement extends class extends polymerElement_js$1.PolymerElement {} {
  static get template() {
    return htmlTag_js$1.html`
    <style>
      :host {
        display: block;
        height: 100%;
...
VaadinGridStyles.appendChild(htmlTag_js$1.html`
  <style>
...
`;
  ...
  _updateItem(row, item) {
    ...
    this._debouncerUpdateHeights = debounce_js$1.Debouncer.debounce(this._debouncerUpdateHeights, async_js$1.timeOut.after(1), () => {
      this._updateMetrics();
  ...
  __forceReflow() {
    this._debouncerForceReflow = debounce_js$1.Debouncer.debounce(this._debouncerForceReflow, async_js$1.animationFrame, () => {
